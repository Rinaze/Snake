        ...
        private void createwall()
        {
            ...
            for (int w = 0; w < wcount; w++)
            {
                ...
                do
                {
                    ...
                    wi = r.Next(0, height - sizehead * wlength - 90);
                    wi -= wi % sizehead;
                    wi += 1;
                    ...
                    {
                        var newwall = new Point(wi + i * sizehead, wj);
                        if (walls.Any(wall => wall.Location == newwall))
                        {
                            intersection = true;
                            break;
                        }
                ...
                for (int i = 0; i < wlength; i++)
                {
                    PictureBox wallPart = new PictureBox();
                    wallPart.BackColor = Color.Black;
                    wallPart.Size = new Size(sizehead, sizehead);
                    wallPart.Location = new Point(wi + i * sizehead, wj);
                    walls.Add(wallPart);
                    this.Controls.Add(wallPart);
                }
            }
        }
